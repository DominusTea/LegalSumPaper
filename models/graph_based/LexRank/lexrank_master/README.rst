...
LexRank algorithm for text summarization.  This is a fork of the original crabcamp's LexRank implementation repository <https://github.com/crabcamp/lexrank/tree/master>.
We made minor changes to the tokenization (which is now similar to PyTextRank) and the text clear functions.  We also added law-domain specific improvements.

To install our version run

.. code-block:: shell

    pip install -e /path/to/lexrank_master 
